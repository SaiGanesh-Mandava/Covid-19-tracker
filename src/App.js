...
import img from './img/covid19.png'
    ...
    <div className="app">
      <div className="app__left">
        ...
        <div className="app__stats">
          ...
          <InfoBox active={casesType === "recovered"} recovered={true} title="Recovered" cases={countryInfo.todayRecovered}  total={countryInfo.recovered} onClick={(e) => setCasesType('recovered')}/>
          <InfoBox active={casesType === "deaths"} deaths={true} title="Deaths"  cases={countryInfo.todayDeaths}  total={countryInfo.deaths} onClick={(e) => setCasesType('deaths')}/>
        </div>
      ...
      <Card raised={true} className="app__right">
        <CardContent>
          ...
          <h3 class="right__chart">World wide new {casesType}</h3>
